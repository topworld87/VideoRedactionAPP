...
public sealed class LocTable : INotifyPropertyChanged
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["audioLane"] = "AUDIO",
        ["audioLaneHint"] = "Drag on this teal track to mute or beep a span",
        ["audioWaveLoading"] = "Loading waveform…",
        ["audioWaveEmpty"] = "No audio track in this file",
        ["audioHint"] = "Audio: drag on the teal waveform below. Marked spans mute/beep in preview and on export.",
        ["audioMute"] = "Mute",
        ["audioBeep"] = "Beep",
        ["audioDelete"] = "Delete span",
        ["tipAudioMute"] = "New spans mute that part of the soundtrack on export.",
        ["tipAudioBeep"] = "New spans replace that part with a beep on export.",
        ["tipAudioDelete"] = "Remove the selected audio span (Delete key).",
        ["tipPreviewMute"] = "Mute preview playback (does not change the export).",
        ["msgAudioFfmpegMissing"] = "Audio redaction needs ffmpeg.exe next to the app.",
        ["msgAudioRemuxFail"] = "Video exported, but audio redaction failed.",
